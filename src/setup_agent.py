...
def _get_system_prompt() -> str:
    ...
    return (
        ...
        "- When you generate a SAR (Suspicious Activity Report) using the workflow tool, "
        "display the full report contents to the user -- do not just say the report was "
        "generated. Format the report output clearly so the user can read and review it "
        ...
        "FinCEN-aligned SAR. No AI is involved in the SAR generation; every field comes from "
        "indexed evidence. Display the full report output to the user.\n\n"
        "AVAILABLE DATA:\n"
